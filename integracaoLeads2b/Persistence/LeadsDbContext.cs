    ...
    public class LeadsDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Leads>(lead =>
            {
                ...
                lead.Property(l => l.Fk_id);
                lead.Property(l => l.List_id);
                ...
                lead.Property(l => l.Opportunity_created_at).IsRequired().HasColumnType("datetime");
                lead.Property(l => l.Opportunity_id);
                lead.Property(l => l.Opportunity_status).HasColumnType("varchar(50)");
                lead.Property(l => l.Order_date).IsRequired().HasColumnType("datetime");
                lead.Property(l => l.Order_total).IsRequired().HasColumnType("decimal(18,2)");
                lead.Property(l => l.Customer_id);
